package com.example.augustmorningcalc
...
import com.example.augustmorningcalc.ui.theme.AugustMorningCalcTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            AugustMorningCalcTheme {
...
fun Calculator(modifier: Modifier = Modifier) {
    Column(modifier = modifier
        ...
        Row(modifier = modifier.fillMaxWidth(),
            ...
            Button(onClick = {
                //convert first and second numbers to double
            ...
            Button(onClick = { //convert first and second numbers to double
                var convertedFirstNum = firstNumber.text.toDouble()
                var convertedSecondNum = secondNumber.text.toDouble()
                //compute the numbers
                var jibu = convertedFirstNum - convertedSecondNum
